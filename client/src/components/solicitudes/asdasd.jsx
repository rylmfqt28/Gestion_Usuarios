...
import TipoUsuar from '../../Service/TipoUsuar';
...
class Solicitudes extends Component{
  ...
  componentDidMount(){
    ...
    TipoUsuar.getAll().then(data => this.setState({TipoUsuario: data}))
    const url="/tipousuario/";
    fetch(url).then(respuesta=> respuesta.json())
    .then(resultado => this.setState({TipoUser: resultado}))
    console.log(this.state.TipoUser);
 }
  ...
  render()
  {
    ...
    return ( 
      <body>
        ...
        { 
         this.renderDatosUsuario(this.state.date)}
         </div>
      </section>
      </body>
       )
     ...
     return (
      <body>
           ...
           <label className="solicitud-label"> Ver solicitudes de tipo </label>
            ...
            {this.state.TipoUsuario.map(elemento => (
